...
def ica_cardio_distribution_plot(path):
...
def ica_loan_distribution_plot(path):
    ...
    plt.title('Financial Loan ICA Distribution')
    plt.savefig('plots/loan_ica_distribution.png')
